...
C:\cmakebuilds\ssao\release\ssao.exe -vert %VSHADER% -frag %FSHADER% -mrt -shade %SHADING% -dRadius .06 -maxRadius 32 -stepMul 1.0 -maxNumSamples 16 -occFact 1 %1 --options %2
